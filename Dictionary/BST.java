...
public class BST implements Comparable<BST> {
	...
	public String toString() {
		String afterConversionToString;
		if (this.getParent() != null) {
			afterConversionToString = "[ Word: " + this.getKeyString() + "\tMeaning: " + this.getValueString()
					+ "\tParent: " + this.getKeyString() + " ]\n";
		} else {
			afterConversionToString = "[ Word: " + this.getKeyString() + "\tMeaning: " + this.getValueString() + " ]\n";
		}
		return afterConversionToString;
	}
