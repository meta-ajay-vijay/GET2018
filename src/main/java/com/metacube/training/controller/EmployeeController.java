...
public class EmployeeController {
	...
	public String adminDashboard(HttpServletRequest request, Principal principal) {
	...
	public String getAllprojects(Model model, HttpServletRequest request) {
		...
		model.addAttribute("employees", employeeService.getEmployeeByIdString(employee.getEmpCode()));
	...
	public ModelAndView search(ModelAndView modelAndView, @RequestParam("skills") String skills[],
